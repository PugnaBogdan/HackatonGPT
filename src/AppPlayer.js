...
import './App.css';
import audio from "./file_example_MP3_5MG.mp3";
...
class AudioPlayer extends HTMLElement {
    ...
    render() {
      this.shadowRoot.innerHTML = `
       ${this.style()}
        ...
        <div class="progress-indicator">
            <span class="current-time" style = "display:none">0:0</span>
            <input type="range" max="100" value="0" class="progress-bar">
            <canvas class="visualizer" style="width: 100%; height: 200px"></canvas>
        </div>
      ...
      this.titleElement = this.shadowRoot.querySelector('.play-btn');
      ...
      this.titleElement.textContent = 'No Audio Source Provided';
